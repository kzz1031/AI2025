...
# 加载和划分数据集
full_train_dataset = CustomMNIST('./minist_train_data', train=True, transform=transform_train)
test_dataset = CustomMNIST('./minist_train_data', train=False, transform=transform_test)
...
model = MNISTNet(kernel_size=10).to(device)
