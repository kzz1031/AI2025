...
from models import ResNet_MNIST
...
LEARNING_RATE = 0.001
PATIENCE = 10  # 增加早停耐心值
WARMUP_EPOCHS = 5  # 预热学习率的epoch数
MAX_GRAD_NORM = 5.0  # 梯度裁剪的最大范数
VALIDATION_SPLIT = 0.2
WEIGHT_DECAY = 0.0005  # 增加L2正则化
...
# 使用不同的transform
full_train_dataset = CustomMNIST('/home/featurize/work/AI2025/Week4-CNN/minist_train_data', 
                                train=True, transform=transform_train)
test_dataset = CustomMNIST('/home/featurize/work/AI2025/Week4-CNN/minist_train_data', 
...
if __name__ == '__main__':
    ...
    if choice == 't' or choice == 'T':
        ...
        model.load_state_dict(torch.load("models/resnet_best_model_minist.pth"))
        ...
        for epoch in range(1, EPOCHS + 1):
            ...
            if val_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), 'resnet_best_model_minist.pth')
            else:
                patience_counter += 1
        ...
        print('Loading best model and testing...')
        model.load_state_dict(torch.load("resnet_best_model_minist.pth"))
        wrong_samples = test(model, device, test_loader)
        print('\nDisplaying some wrong predictions:')
        plot_wrong_predictions(wrong_samples)
